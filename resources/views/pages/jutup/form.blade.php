...
@section('title', ' Form Jurnal Penutup')
@section('content')

    <section class="section">
        <form method="POST" action="/jurnalpenutup/store">
            @csrf
            <div>
                <div class="section-header">
                    <h4> Transaksi <br> Jurnal Penutup</h1>
                </div>

                <div class="section-header">
                    <div class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="top">
                        {{-- <strong>
                        ...
                        <select name="status" class="form-control">
                            <option value="jutup">jutup</option>

                        </select>
                    </div>
                </div>

                <input type="text" name="transaksi_id" value="{{ request()->transaksi_id }}">
                ...
                <div class=" text-right plus float-right" style="margin-bottom: 10px">
                    <a href="/jurnalpenutup" type="reset" class="btn btn-danger">Batal</a>
                    <button id="btnSubmit" type="submit" disabled class="btn btn-success">Buat Jurnal Penutup</a>
                </div>
