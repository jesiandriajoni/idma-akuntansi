...
@section('title', ' Edit Jurnal Penutup')
@section('content')

    <section class="section">
        <form method="POST" action="/jurnalpenutup/{{ $transaksi_id }}/update">
            ...
            <div>
                ...
                {{-- <input type="hidden" name="tanggal2" value="{{  $tanggal }}"> --}}
                {{-- <input type="hidden" name="tanggal2" value="{{ $jurnalpenutups[0]->Transaksi->tanggal }}"> --}}
                ...
                <div class=" text-right plus float-right" style="margin-bottom: 10px">
                    ...
                    <button id="btnSubmit" type="submit" disabled class="btn btn-success">Edit Jurnal Penutup</button>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody id="bungkus">
                        @foreach ($jurnalpenutups as $jurnal)
                            <tr id="baris">
                                <td>
