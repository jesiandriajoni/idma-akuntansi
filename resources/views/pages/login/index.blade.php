        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="text-primary"><h6>Sistem Informasi Akuntansi</h6></div>
              <div class="text-primary"><h5>PT. INOVINDO DIGITAL MEDIA</h5></div><br>
              </div>
            ...
            {{-- <small class="d-block text-center mt-3">Belum Registrasi? <a href="/register">Registrasi Disini!</a></small> --}}
          </div>
        </div>
      </div>
    </section>
