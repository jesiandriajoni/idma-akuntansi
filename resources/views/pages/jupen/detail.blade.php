...
@section('title', 'Detail Jurnal Penyesuaian')
@section('content')
    <section class="section">

        <div>
            <div class="section-header">
                <h4> Laporan <br> Jurnal Penyesuaian</h1>
            </div>
            {{-- <label>Filter Data Jurnal Umum Berdasarkan Tanggal</label>
            <form action="/jurnalpenyesuaian/search" method="GET">
                        ...
                        <div class="row">
                            <th colspan="6" type="date" name="tanggal">Tanggal: {{ $item['tanggal'] }}
                                ...
                                <div class="row" style="margin-left:870px;margin-top:-30px">
                                    <a href="/jurnalpenyesuaian/{{ $item->id }}/edit" class="btn btn-primary">Edit</a>

                                    <form action="/jurnalpenyesuaian/{{ $item->id }}/delete" method="POST">
                                        @csrf
                                        @method('DELETE')
