...
@section('title', ' form jurnal umum')
@section('content')

    <section class="section">
        <form method="POST" action="/jurnalumum/store">
            @csrf
            <div>
                <div class="section-header">
                    <h4> Transaksi <br> Jurnal Umum</h1>
                </div>
                ...
                {{-- <div class="section-header" button type="button" class="btn btn-secondary" data-container="body"


            </div> --}}
                {{-- menambahkan transaksi_id di jurnalumum --}}
                <input type="text" style="width: 195px" name="transaksi_id" value="{{ request()->transaksi_id }}" readonly>
                ...
                <div class=" text-right plus float-right" style="margin-bottom: 10px">
                    <a href="/jurnalumum/" type="reset" class="btn btn-danger">Batal</a>
                    <button id="btnSubmit" type="submit" disabled class="btn btn-success">Buat Jurnal Umum</a>
                </div>
