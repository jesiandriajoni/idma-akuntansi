...
@section('content')
    ...
    <section class="section">
        <form method="POST" action="/jurnalumum/{{ $transaksi_id }}/update">
            ...
            <div>
                ...
                <input type="hidden" name="tanggal2" value="{{ $jurnalumums[0]->Transaksi->tanggal }}">
                ...
                <div class=" text-right plus float-right" style="margin-bottom: 10px">
                    ...
                    <button id="btnSubmit" type="submit" disabled class="btn btn-success">Edit Jurnal Umum</button>
                </div>
