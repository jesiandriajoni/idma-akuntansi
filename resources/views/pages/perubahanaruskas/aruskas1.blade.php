            ...
            <div class ="text-center">
                ...
                <div class ="text-left" style="margin-top:90px">
                    <div>
                            <div>
                                <div class ="text-left">
                                    <strong><h5 style="text-indent: 66px;margin-bottom:20px">Arus Kas Dari Aktivitas Operasi</h5></strong>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="card" style="width: 52rem; margin-left:50px">
                            ...
                            <strong ><h6><p>Penerimaan Kas</p></h6></strong>

                            <table class="table table-bordered">

                                    <tr>
                                        <td style="text-indent: 50px;">Kas Dari Pendapatan</td>
                                        <td style="text-indent: 50px;">Rp10.000.000</td>
                                    ...
                                    <tr>
                                        <td style="text-indent: 50px;"><strong>Penerimaan Kas Dari Aktivitas Operasi</strong></td>
                                        <td style="text-indent: 50px;">-</td>
                                        <td style="text-indent: 50px;">-</td>
                                    </tr>
                        ...
                        <div class="card" style="width: 52rem; margin-left:50px">
                            <strong><h6><p>Pengeluaran Kas</p></h6></strong>
                            <table class="table table-bordered">
                    ...
                    <table>
                        <tr>
                            <td style="text-indent: 90px;"><strong>Kas Bersih Dari Aktivitas Operasi</strong></td>
                  ...
                  <div>
                    ...
                    <div class ="text-left">
                        <strong><h5 style="text-indent: 66px;margin-bottom:20px">Arus Kas Dari Aktivitas Investasi</h5></strong>
                    </div>
                </div>
                ...
                <div class ="text-left">
                    <strong><h5 style="text-indent: 66px;margin-bottom:20px">Arus Kas Dari Aktivitas Pendanaan</h5></strong>
                </div>
                ...
                <table>
                    <tr>
                        <td style="text-indent: 100px;"><strong>Penerimaan / Pengurangan Kas</strong></td>
