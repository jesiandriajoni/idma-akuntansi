...
@section('title', 'Detail Bukti Transaksi Masuk')
@section('content')
    <section class="section">
        ...
        <div class="section-header justify-content-center">
            <div class="text-center">
                ...
                <h5>Detail Bukti Transaksi Masuk</h5>

            </div>
        </div>
        <div>

            <a href="/transaksimasuk/create" type="button" class="btn btn-success" style="margin-top: 15px"> + Tambah
                Data</a>
            <a href="/transaksimasuk/cetaktrmasuk" class="btn btn-warning" target="_blank" style="margin-top:15px"><i
            ...
            <tbody>
                ...
                @forelse ($butransmasuks as $item)
                    <tr>
                        ...
                        <div class="row">
                            <td>
                                <a href="/transaksimasuk/{{ $item->id }}/edit" class="btn btn-info"><i
                                        class="fas fa-edit" style="color:rgb(13, 0, 255)"></i></a>

                            <td>
                                <form action="/transaksimasuk/{{ $item->id }}/hapus" method="POST"></a>
                                    @csrf
                                    @method('DELETE')
                            ...
                            <td>
                                ...
                                <a href="/transaksimasuk/{{ $item->id }}/cetak" target="_blank"
