...
@section('content')
    <section class="section">
        ...
        <div class="container">
            <form method="POST" action="/transaksimasuk/{{ $butransmasuks->id }}/update">
                ...
                <div class="card-body">
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" readonly name="notr"
                                value="{{ old('notr') ?? $butransmasuks->notr }}">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="date" class="form-control" name="tanggal"
                                value="{{ old('tanggal') ?? $butransmasuks->tanggal }}">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" name="diterima"
                                value="{{ old('diterima') ?? $butransmasuks->diterima }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input id="nominal" onkeyup="kataterbilang()" type="text" class="form-control" name="nominal"
                                autocomplete="off" value="{{ old('niminal') ?? $butransmasuks->nominal }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="terbilang" class="form-control" name="terbilang"
                                value="{{ old('terbilang') ?? $butransmasuks->terbilang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <textarea class="form-control" name="ket" value="">{{ old('ket') ?? $butransmasuks->ket }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" readonly name="nama_direktur"
                                value="{{ old('nama_direktur') ?? $butransmasuks->nama_direktur }}">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" readonly name="nama_karyawan"
                                value="{{ old('nama_karyawan') ?? $butransmasuks->nama_karyawan }}">
                        </div>
                    </div>
