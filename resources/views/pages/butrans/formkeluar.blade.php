...
@section('content')
    ...
    <section class="section">
        ...
        <div class="container">
            <form method="POST" action="/transaksikeluar/store">
                @csrf
                <div class="card-body">
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">TR NO :</label>
                        <div class="col-sm-12 col-md-7">
                            <input value={{ $notr }} type="text" readonly class="form-control" name="notr"
                                placeholder="Contoh --001/VII/2022--">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Dibayarkan Kepada :</label>
                        <div class="col-sm-12 col-md-7">
                            <input type="text" autocomplete="off" class="form-control" name="dibayar">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Banyaknya Uang :</label>
                        <div class="col-sm-12 col-md-7">
