...
class LaporanperubahanmodalController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->akun_id) {
            ...
            $kelompok = Jurnalumum::with('Akun')->where('status', 'jumum')->where('tanggal', "like", "%" . date("Y-m") . "%")->orderBy('tanggal')->orderBy('id')->get();
        }
        ...
        // dd($data);
        //dd($kelompokHasil);
        return view('pages.laporan.permo', $data);
    }
    public function cetak(Request $request)
    {
        ...
        // dd($data);
        //dd($kelompokHasil);
        return view('pages.laporan.pdfpermo', $data);
    }
    /**
